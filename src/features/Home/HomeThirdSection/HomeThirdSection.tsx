...
export const HomeThirdSection = () => {
  return (
    ...
    bg-center  lg:px-[160px] pt-16 lg:pt-[88px]  lg:pb-[174px]'>
        <Flex direction='col' className='    min-[1921px]:max-w-[1800px] gap-2 lg:gap-6  lg:max-w-[50vw] w-full'>
          ...
          <Flex direction='col' className='gap-6 lg:gap-14 w-full '>
            ...
            <Flex className='w-full lg:px-0 px-[5%] justify-between min-[1921px]:justify-start min-[1921px]:gap-14' align='end'>
              ...
              <Flex align='center' className='hidden min-[1440px]:flex w-fit py-2 gap-4 border-b-[1px] border-secondary-pure'>
            ...
            <Flex align='center' className=' hidden lg:flex min-[1440px]:hidden w-fit py-2 gap-4 border-b-[1px] border-secondary-pure'>
              <p className='font-[600]'>COMPRAR AGORA</p>
              <button >
                <Icons.ArrowRight className='h-6 w-6' />
              </button>
            ...
            <Preenchedores />
            <Flex align='center' className='px-[5%] hidden  max-[1023px]:flex w-full py-2 gap-4'>
              <Flex align='center' className='hidden mb-16 max-[1023px]:flex w-full py-2 gap-4 border-b-[1px] border-secondary-pure'>
                <p className='font-[600]'>COMPRAR AGORA</p>
                <button >
                  <Icons.ArrowRight className='h-6 w-6' />
                </button>
            ...
            <Flex className='lg:hidden h-[203px] min-[410px]:h-[230px] md:h-[420px]  '>
              <Image src='/assets/mobilePreenchedores.png' className="object-cover min-[768px]:object-contain" width={2000} height={468} alt='Preenchedores' quality={100} priority />
            </Flex>
          </Flex>
        </Flex>
      </Flex>
