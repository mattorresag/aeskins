...
export const ProgramacaoCard = ({
  ...
  return (
    <Flex className="flex-col md:flex-row w-full border-[1px] border-neutral-pure100">
      <Flex className="p-2 border-r-[1px] border-r-neutral-pure100">
        <Flex className="relative w-full md:w-[160px]">
          <Flex className="w-full hidden md:flex">
            <Image
              src={avatar}
              alt={name}
              width={160}
          ...
          <p className="min-w-[40%] lg:min-w-[85%] absolute bottom-0 left-0 p-2 bg-secondary-pure text-white text-[14px] leading-[21px]">
            {name}
          </p>
        </Flex>
      </Flex>
      <Flex direction="col" className="md:p-6 p-4 gap-3" justify="center">
        <Flex className="gap-4">
          <Flex className="w-full justify-center md:w-fit rounded-3xl pr-3 pl-1 py-1 border-[1px] border-secondary-pure10">
            <svg
            ...
            <p className="text-neutral-pure500 font-[500] text-[14px] lg:text-[18px] leading-[27px]">
              {start} às {end}
            </p>
          </Flex>
